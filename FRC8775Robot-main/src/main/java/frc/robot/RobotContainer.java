...
public class RobotContainer {
  ...
  ArmComponent redArm = new ArmComponent(Constants.redArmId);
  ArmComponent yellowArm = new ArmComponent(Constants.yellowArmId);
  ArmComponent tiltArm = new ArmComponent(Constants.tiltId);
