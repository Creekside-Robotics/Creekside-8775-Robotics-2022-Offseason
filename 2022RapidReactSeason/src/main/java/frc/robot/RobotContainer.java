...
public class RobotContainer {
  ...
  ArmComponent redArm = new ArmComponent(Constants.redArmId, 1, Constants.redRevInRan);
  ArmComponent yellowArm = new ArmComponent(Constants.yellowArmId, 1, Constants.yellowRevInRan);
  ArmComponent tiltArm = new ArmComponent(Constants.tiltId, 1, Constants.tiltRevInRan);
